...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("IP Whitelisting", "Witte Lijst met IP's"),
        ...
        ("Key mismatch", "Sleutel komt niet overeen"),
        ("Timeout", "Time-out"),
        ...
        ("Use IP Whitelisting", "Witte lijst met IP-adressen gebruiken"),
        ("Network", "Netwerk"),
        ...
        ("ubuntu-21-04-required", "Wayland vereist Ubuntu versie 21.04 of nieuwer."),
        ("wayland-requires-higher-linux-version", "Wayland vereist een linux distro met een hogere versie. Probeer X11 desktop of pas het OS aan."),
        ("xdp-portal-unavailable", "Wayland schermopname is mislukt. De XDG Desktop Portal kan gecrashed zijn of is onbeschikbaar. Probeer het opnieuw te starten met `systemctl --user restart xdg-desktop-portal`."),
        ("JumpLink", "JumpLink"),
        ...
        ("Swap control-command key", "Control-Command-toets wisselen"),
        ...
        ("password-hidden-tip", "Permanent wachtwoord is ingesteld (verborgen)."),
        ("preset-password-in-use-tip", "Het vooraf ingestelde wachtwoord is momenteel in gebruik."),
        ("Enable privacy mode", "Privémodus inschakelen"),
        ("allow-remote-toolbar-docking-any-edge", "Koppelen van de externe werkbalk toestaan aan elke vensterrand"),
        ("API Token", "API-token"),
        ("Deploy", "Inzetten"),
        ("Custom ID (optional)", "Aangepast ID (optioneel)"),
        ("server_requires_deployment_tip", "De server vereist dat dit apparaat expliciet wordt ingezet. Nu inzetten?"),
        ("The server does not require explicit deployment.", "De server vereist geen expliciete inzet."),
        ("Unknown response.", "Onbekende respons"),
        ("wayland-keyboard-input-disabled-tip", "Toetsenbordinvoer toestaan?"),
        ("wayland-keyboard-input-consent-tip", "Wat u op deze externe computer typt (inclusief wachtwoorden), kan door andere apps erop worden gelezen."),
        ("wayland-keyboard-input-applies-to-tip", "Deze keuze geldt voor:"),
        ("wayland-soft-keyboard-input-label", "Invoer van schermtoetsenbord"),
        ...
        ("Your ID is blocked by the peer", "Uw ID wordt door de ander geblokkeerd"),
