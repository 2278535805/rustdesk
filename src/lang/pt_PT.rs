...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Remove", "Remover"),
        ("Refresh random password", "Actualizar palavra-passe"),
        ...
        ("Wrong Password", "Palavra-passe inválida"),
        ...
        ("Are you sure you want to delete this empty directory?", "Tem a certeza que deseja apagar este diretório vazio?"),
        ("Are you sure you want to delete the file of this directory?", "Tem a certeza que deseja apagar este ficheiro deste diretório?"),
        ...
        ("Failed to make direct connection to remote desktop", "Falha ao fazer ligação directa ao ambiente de trabalho remoto"),
        ("Set Password", "Definir palavra-passe"),
        ("OS Password", "Palavra-Passe do SO"),
        ...
        ("agreement_tip", "Ao iniciar a instalação, está a concordar com o acordo de licença."),
        ...
        ("setup_server_tip", "Para uma ligação mais rápida, por favor configure o seu próprio servidor"),
        ...
        ("Auto Login", "Login Automático (Apenas válido se tiver activado \"Bloquear após o fim da sessão\")"),
        ...
        ("Fix it", "Reparar"),
        ("Warning", "Aviso"),
        ("Login screen using Wayland is not supported", "Ecrã de Início de Sessão com Wayland não é suportado"),
        ...
        ("Always connect via relay", "Ligar sempre via relay"),
        ...
        ("Password missed", "Palavra-passe em falta"),
        ("Wrong credentials", "Nome de utilizador ou palavra-passe incorrectos"),
        ...
        ("Are you sure to close the connection?", "Tem a certeza que deseja fechar a ligação?"),
        ...
        ("Canvas Move", "Mover Ecrã"),
        ("Pinch to Zoom", "Clique para ampliar"),
        ("Canvas Zoom", "Zoom no Ecrã"),
        ("Reset canvas", "Reiniciar ecrã"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, é necessário permitir que o RustDesk use o serviço \"Acessibilidade\"."),
        ...
        ("Use permanent password", "Utilizar palavra-passe permanente"),
        ("Use both passwords", "Utilizar ambas as palavras-chave"),
        ("Set permanent password", "Definir palavra-passe permanente"),
        ...
        ("Mobile Actions", "Ações para telemóvel"),
        ...
        ("wayland-requires-higher-linux-version", "Wayland requer uma versão superior da distribuição Linux. Por favor, tente o ambiente de trabalho X11 ou mude o seu sistema operativo."),
        ...
        ("JumpLink", "View"),
        ("Please Select the screen to be shared(Operate on the peer side).", "Por favor, selecione o ecrã a partilhar (operar no lado do par)."),
