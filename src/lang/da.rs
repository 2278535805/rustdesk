...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("wayland-requires-higher-linux-version", "Wayland kræver en højere version af Linux-distro. Prøv venligst X11-desktoppen eller skift dit OS."),
        ...
        ("One-time password length", "Længde af engangskode"),
        ...
        ("Request Elevation", "Efterspørg elevation"),
        ...
        ("relay_hint_tip", "Det er måske ikke muligt at forbinde direkte; du kan forsøge at forbinde via en relay-server. Hvis du ønsker at bruge en relay-server på dit første forsøg, kan du tilføje \"/r\" efter ID'et, eller bruge valgmuligheden \"Forbind altid via relay-server\" i fanen for seneste sessioner, hvis den findes."),
        ("Reconnect", "Genopret"),
        ("Codec", "Codec"),
        ("Resolution", "Opløsning"),
        ("No transfers in progress", "Ingen overførsler i gang"),
        ("Set one-time password length", "Sæt længde af engangsadgangskode"),
        ...
        ("empty_lan_tip", "Åh nej, det ser ud til, at vi ikke har kunnet finde nogen modparter endnu."),
        ("empty_address_book_tip", "Åh nej, det ser ud til at der ikke er nogen modparter, der er tilføjet til din adressebog."),
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge RustDesk til at forbinde til din PC, så stop med det samme, og læg på omgående."),
        ("scam_text2", "Det er højst sandsynligvis en svinder som forsøger at stjæle dine penge eller andre personlige oplysninger."),
        ...
        ("Filter by intersection", "Filtrér efter fællesmængde"),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, hvilket kan forhindre RustDesk i at køre normalt."),
        ...
        ("idd_not_support_under_win10_2004_tip", "Indirekte grafikdrivere er ikke understøttet. Windows 10 version 2004 eller nyere er påkrævet."),
        ("input_source_1_tip", "Input kilde 1"),
        ("input_source_2_tip", "Input kilde 2"),
        ("Swap control-command key", "Byt rundt på Ctrl- og Command-tasterne"),
        ("swap-left-right-mouse", "Byt rundt på venstre og højre musetaster"),
        ("2FA code", "To-faktorkode"),
        ("More", "Mere"),
        ("enable-2fa-title", "Tænd for to-faktorgodkendelse"),
        ("enable-2fa-desc", "Åbn din godkendelsesapp nu. Du kan bruge en godkendelsesapp såsom Authy, Microsoft eller Google Authenticator på din telefon eller din PC.\n\nScan QR-koden med din app og indtast koden som din app fremviser for at aktivere to-faktorgodkendelse."),
        ("wrong-2fa-code", "Kan ikke verificere koden. Sikr dig at koden og tidsindstillingerne på enheden er korrekte"),
        ("enter-2fa-title", "To-faktorgodkendelse"),
        ("Email verification code must be 6 characters.", "E-mail-bekræftelseskoden skal være på 6 tegn"),
        ("2FA code must be 6 digits.", "To-faktorkoden skal være på 6 cifre"),
        ...
        ("Everyone", "Alle"),
        ("ab_web_console_tip", "Mere på webkonsollen"),
        ("allow-only-conn-window-open-tip", "Tillad kun fjernforbindelser hvis RustDesk-vinduet er synligt"),
        ("no_need_privacy_mode_no_physical_displays_tip", "Ingen fysiske skærme, ikke nødvendigt at bruge privatlivstilstanden."),
        ("Follow remote cursor", "Følg musemarkør på fjernforbindelse"),
        ("Follow remote window focus", "Følg vinduesfokus på fjernforbindelse"),
        ...
        ("clear_Wayland_screen_selection_tip", "Efter du har fravalgt den valgte skærm, kan du vælge skærmen som skal deles."),
        ...
        ("floating_window_tip", "Det hjælper til at holde RustDesk-baggrundstjenesten kørende"),
        ...
        ("enable-bot-tip", "Hvis du aktiverer denne funktion, kan du modtage to-faktorgodkendelseskoden fra din robot. Den kan også fungere som en notifikation for forbindelsesanmodninger."),
        ...
        ("cancel-2fa-confirm-tip", "Er du sikker på at du vil afbryde to-faktorgodkendelse?"),
        ...
        ("enable-trusted-devices-tip", "Spring to-faktorgodkendelse over på troværdige enheder"),
